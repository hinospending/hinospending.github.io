...
OpenSpending.Styles.Cofog = {
  ...
  '2.1': { icon: 'icons/schools.svg', color: '#C75746', bcolor: '#0AB971' },
  '2.2': { icon: 'icons/pre-school.svg', color: '#C75746', bcolor: '#0AB971' },
  '2.3': { icon: 'icons/education.svg', color: '#C75746', bcolor: '#0AB971' },
  '2.4': { icon: 'icons/economy-tourism.svg', color: '#C75746', bcolor: '#4E6D00' },
  '2.5': { icon: 'icons/dollar.svg', color: '#C75746', bcolor: '#4E6D00' },
  '2.6': { icon: 'icons/harbor.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3': { icon: 'icons/culture.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3.1': { icon: 'icons/our-streets.svg', color: '#C75746', bcolor: '#D33673' },
  '3.2': { icon: 'icons/farms.svg', color: '#C75746', bcolor: '#D33673' },
  '3.3': { icon: 'icons/street-lights.svg', color: '#C75746', bcolor: '#D33673' },
  '3.4': { icon: 'icons/housing.svg', color: '#C75746', bcolor: '#D33673' },
  '4': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#2A3A03' },
  '4.1': { icon: 'icons/tree.svg', color: '#C75746', bcolor: '#2A3A03'  },
  '4.2': { icon: 'icons/wind.svg', color: '#C75746', bcolor: '#2A3A03'  },
  '4.3': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' },
  '5': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' },
  '6': { icon: 'icons/traffic-watersup.svg', color: '#C75746', bcolor: '#938626' },
